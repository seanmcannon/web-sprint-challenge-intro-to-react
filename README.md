...
It allows data to be changed dynamically based on user input.
...
a component with a render prop takes a function that returns an element and calls it instead of its own render.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props? 

Side effects are anythign that happens outside the scope of the current function. sync using hooks.
